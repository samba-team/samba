...
void cred_create(uchar session_key[8], DOM_CHAL *stor_cred, UTIME timestamp, DOM_CHAL *cred)
{
	DOM_CHAL time_cred;
...
void cred_create_zerotime(uchar session_key[8], DOM_CHAL *stor_cred, DOM_CHAL *cred)
{
	UTIME ts;
	zerotime.time = 0;
	cred_create(session_key, stor_cred, zerotime, cred);
}
...
BOOL cred_assert(DOM_CHAL *cred, uchar session_key[8], DOM_CHAL *stored_cred, UTIME timestamp)
{
	DOM_CHAL cred2;
...
BOOL cred_assert_zerotime(DOM_CHAL *cred, uchar session_key[8], DOM_CHAL *stored_cred)
{
	UTIME ts;
	zerotime.time = 0;
	return cred_assert(cred, session_key, stored_cred, ts);
}
