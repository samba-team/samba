...
static struct cli_tree	*smb_connect(const char *, const char *, int, const char *, const char *, const char *);
static int		smb_print(struct cli_tree *, char *, FILE *);
     ...
     char *argv[])		/* I - Command-line arguments */
{
  ...
  struct cli_tree *cli;	/* SMB interface */
...
static struct cli_tree *		/* O - SMB connection */
...
{
  struct cli_tree	*c;		/* New connection */
  ...
  */
  ...
  nt_status = cli_tree_full_connection(&c, myname, server, port, share, "?????", 
...
smb_print(struct cli_tree *cli,	/* I - SMB connection */
          ...
          FILE             *fp)		/* I - File to print */
{
  ...
  */
  ...
  if (NT_STATUS_IS_ERR(cli_close(cli, fnum)))
  {
