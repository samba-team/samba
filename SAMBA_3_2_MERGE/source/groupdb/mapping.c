...
****************************************************************************/
char *decode_sid_name_use(fstring group, enum samr_SidType name_use)
{	
...
****************************************************************************/
BOOL add_initial_entry(gid_t gid, const char *sid, enum samr_SidType sid_name_use, const char *nt_name, const char *comment)
{
	GROUP_MAP map;
...
static BOOL enum_group_mapping(enum samr_SidType sid_name_use, GROUP_MAP **rmap,
				  ...
				  struct acct_info **info)
{
	...
	GROUP_MAP *map;
	int i, num_maps;
	enum samr_SidType type = SID_NAME_UNKNOWN;
