...
typedef struct sam_group {
	...
	struct group_data {
		...
		enum samr_SidType sid_name_use;	/* Group type */
...
typedef struct pdb_context 
{
	...
	NTSTATUS (*pdb_get_group_list)(struct pdb_context *context, GROUP_INFO **info, const enum samr_SidType sid_name_use, int *num_groups);
...
typedef struct pdb_methods 
{
	...
	NTSTATUS (*get_group_list)(struct pdb_methods *methods, GROUP_INFO **info, const enum samr_SidType sid_name_use, int *num_groups);
