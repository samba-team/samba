...
typedef struct smb_sign_info_x {
	void (*sign_outgoing_message)(char *outbuf, struct smb_sign_info_x *si);
	BOOL (*check_incoming_message)(char *inbuf, struct smb_sign_info_x *si, BOOL expected_ok);
	void (*free_signing_context)(struct smb_sign_info_x *si);
