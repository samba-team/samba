...
BOOL lookup_known_rid(DOM_SID *sid, uint32 rid, char *name, enum samr_SidType *psid_name_use)
{
	int i = 0;
...
BOOL map_name_to_wellknown_sid(DOM_SID *sid, enum samr_SidType *use, const char *name)
{
	int i, j;
