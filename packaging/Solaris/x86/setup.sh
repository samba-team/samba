...
ln -sf /etc/init.d/samba.init /etc/rc0.d/K01samba
ln -sf /etc/init.d/samba.init /etc/rc2.d/K91samba
ln -sf /etc/init.d/samba.init /etc/rc3.d/S91samba
echo "Done. Now settting up samba command"
ln /etc/init.d/samba.init /sbin/samba
echo "Done."
