...
#
# authentication policy - manage user-allowed-to-authenticate-to property
#
...
class cmd_domain_auth_policy_user_allowed_to_authenticate_to_set(Command):
    """Set the user-allowed-to-authenticate-to property based on scenario.

    --by-group:

        A target service, on a user account, requires the connecting
        user to be in GROUP.

    --by-silo:

        A target service, on a user account, requires the connecting user
        to be in SILO.
    ...
    takes_options = [
        ...
        Option("--by-group",
               help="A target service, on a user account, "
    ...
    def run(self, hostopts=None, sambaopts=None, credopts=None, name=None,
        ...
        policy.user_allowed_to_authenticate_to = sddl
...
class cmd_domain_auth_policy_user_allowed_to_authenticate_to(SuperCommand):
    """Manage the user-allowed-to-authenticate-to property."""

    subcommands = {
        "set": cmd_domain_auth_policy_user_allowed_to_authenticate_to_set(),
    }
