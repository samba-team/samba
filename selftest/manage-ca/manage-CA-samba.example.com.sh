...
./manage-ca.sh manage-CA-samba.example.com.cnf create_dc plugindc.plugindom.samba.example.com 0123456789ABCDEF
./manage-ca.sh manage-CA-samba.example.com.cnf create_user administrator@plugindom.samba.example.com
