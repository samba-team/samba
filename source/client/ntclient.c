				...
				int Client, int cnum)
{
	...
	/* side-effect is to get a new workstation trust account password */
	wksta_trust_account_check(dest_ip, dest_host,
				myhostname, workgroup, mach_acct,
				mach_pwd, new_mach_pwd);
