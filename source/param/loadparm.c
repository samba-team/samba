...
FN_GLOBAL_STRING(lp_ldap_computers_subcontext,
		 &Globals.szLdapComputersSubcontext);
FN_GLOBAL_STRING(lp_ldap_users_subcontext, &Globals.szLdapUsersSubcontext);
FN_GLOBAL_STRING(lp_ldap_builtin_subcontext,
		 &Globals.szLdapBuiltinSubcontext);
#endif /* WITH_NT5LDAP */
