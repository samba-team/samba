...
NTSTATUS cli_nt_login_interactive(struct cli_state *cli, const char *unix_domain, const char *unix_username, 
				uint32 smb_userid_low, const char *unix_password,
...
NTSTATUS cli_nt_login_network(struct cli_state *cli, const char *unix_domain, const char *unix_username, 
