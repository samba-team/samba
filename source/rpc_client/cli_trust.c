...
%s to Domain controller %s. Error was %s.\n", 
			global_myname_unix(), domain, remote_machine, cli_errstr(&cli)));
...
BOOL change_trust_account_password( const char *domain, char *remote_machine)
{
	...
	res = modify_trust_password(domain, dc_name, old_trust_passwd_hash, new_trust_passwd_hash);	
