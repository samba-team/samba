...
for env in ["s3dc", "member", "ad_member", "ad_dc_ntvfs", "s4member"]:
...
for env in ["s3dc", "member", "ad_member"]:
...
# test the dirsort module.
        ...
        for env in ["s3dc:local", "ad_member:local", "member:local", "ad_dc:local", "ad_dc_ntvfs:local"]:
